...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:hidden bg-white shadow-xl px-4 py-5 flex justify-between  z-[9999]">
      ...
      <aside
        ...
        } fixed top-0 left-0 z-50 bg-[#EBECF2] w-48 md:w-20 h-screen md:flex items-center flex-col p-5 transition-all`}
      >
        <div>

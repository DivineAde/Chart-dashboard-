...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className="md:hidden bg-white p-4 flex justify-end z-[9999]"
      >
        <svg
          width="24"
      ...
      <aside
        className={`${
          isSidebarOpen ? "block transition-all" : "hidden transition-all"
        } fixed top-0 left-0 z-50 bg-[#EBECF2] dark:bg-[var(--background)] w-20 h-screen md:flex items-center flex-col p-5 ease-in-out delay-150`}
      >
        <div>
          <Image src="/Vector.png" width={40} height={40} alt="logo" />
        </div>
